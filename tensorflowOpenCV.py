...
with tf.Session() as sess:
    # 以二进制的方式读取图片。
    image_raw_data = tf.gfile.FastGFile("/Users/dudu/PycharmProjects/tensorflow/data/image/u=1670324097,1966289191&fm=27&gp=0.jpg", "rb").read()
    ...
    # opencv读取同一张图片。
    img = cv2.imread("/Users/dudu/PycharmProjects/tensorflow/data/image/u=1670324097,1966289191&fm=27&gp=0.jpg")
